...
public class SelectDevTypeAdapter extends BaseAdapter {
...
//    }
    ...
    public SelectDevTypeAdapter(Context context, int[] icon, int[] iconName) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.seldev_typ_item, null);
